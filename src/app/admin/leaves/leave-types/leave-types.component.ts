...
@Component({
  ...
  styleUrls: ["./leave-types.component.sass"],
})
  ...
  implements OnInit
{
  ...
  exampleDatabase: LeaveTypesService | null;
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        case "id":
          ...
          break;
        case "leave_name":
          [propertyA, propertyB] = [a.leave_name, b.leave_name];
          break;
        case "type":
          [propertyA, propertyB] = [a.type, b.type];
          break;
        case "leaveTo":
          [propertyA, propertyB] = [a.leave_unit, b.leave_unit];
          break;
        case "status":
